...
- **Coverage**: if the test output reports a coverage value and it is
  ...
  `doc/conventions/testConventions.md`). Locate the uncovered lines and
...
- `doc/conventions/codeConventions.md`
- `doc/conventions/testConventions.md`
- `doc/conventions/documentationConventions.md`
...
**Convention/axis**: <codeConventions.md §… | Performance | Security | …>
